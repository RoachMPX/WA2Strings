...
TradeSkillMaster_ShoppingDB = {
	...
	["_scopeKeys"] = {
		["char"] = {
			"Blattaris - Proudmoore", -- [1]
			"Ferford - Proudmoore", -- [2]
			"Cyprinidae - Proudmoore", -- [3]
			"Ilarian - Proudmoore", -- [4]
			"Lyx - Proudmoore", -- [5]
			"Mephrax - Proudmoore", -- [6]
			"Sildris - Emerald Dream", -- [7]
			"Garmuul - Emerald Dream", -- [8]
			"Lithri - Dalaran", -- [9]
			"Gaornash - Dalaran", -- [10]
			"Zetorus - Proudmoore", -- [11]
